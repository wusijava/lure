<template>
    <div>
        <div style="margin-top: 8px">
            <van-button type="default" style="margin-left: 22px" @click="getSize(20)">20以内</van-button>
            <van-button type="default" style="margin-left: 20px" @click="getSize(30)">30以内</van-button>
            <van-button type="default" style="margin-left: 20px" @click="getSize(50)">50以内</van-button>

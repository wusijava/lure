        ...
        <div class="content">
            <div class="list" v-for="item in list" :key="item.id" >
                <van-cell-group :title="item.createTime">
                    ...
                    <van-cell title="省" :value="item.province" />
                    <van-cell title="市" :value="item.city" />
                    <van-cell title="区" :value="item.district" />
...
<script>
    import {myAddress} from "../../api/order";
    import Vue from 'vue';
    ...
    export default {
        ...
        methods: {
            ...
            getList: async function(cp,c) {
                ...
                params.limit = c;
                if(this.value1){
                    params.name=this.value1
                }
                const result = await myAddress(params);
                this.$toast.clear();

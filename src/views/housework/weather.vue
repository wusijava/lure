<template>
    <div class="box">
        <van-notice-bar
                left-icon="volume-o"
                text="天气预报:湖北省-武汉市-蔡甸区,提前知晓天气,有雨带伞!"
        />
        ...
        <div class="content">
            <div class="list" v-for="item in list" :key="item.id" >
                <van-cell-group >
                    ...
                    <van-cell title="地址" :value="item.location" />
                    <van-cell title="数据更新时间" :value="item.loc" />
                    <van-cell title="白天天气" :value="item.condTxtDay" />
                    <van-cell title="夜间天气" :value="item.condTxtNight" />
                    <van-cell title="湿度" :value="item.hum" />
                    <van-cell title="气压" :value="item.pres" />
                    <van-cell title="日出时间" :value="item.sunRise" />
                    <van-cell title="日落时间" :value="item.sunSet" />
                    <van-cell title="温度" :value="item.temp" />
                    <van-cell title="风向" :value="item.windDir" />
                    <van-cell title="风力" :value="item.windSc" />
                    <van-cell title="风速" :value="item.windSpd" />
                </van-cell-group>
                </div>
...
<script>
    import {weatherList,receiveWork} from "../../api/order";
    import Vue from 'vue';
